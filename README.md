...
1. **User Server**:
    ...
    - `user-client` - клиент для взаимодействия с `user-service`
2. **Company Server**:
    - `company-service` - сервис для работы с компаниями
    - `company-client` - клиент для взаимодействия с `company-service`
3. **Gateway**:
