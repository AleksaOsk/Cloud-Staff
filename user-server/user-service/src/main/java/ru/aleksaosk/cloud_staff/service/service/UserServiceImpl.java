...
public class UserServiceImpl implements UserService {
    ...
    public UserResponseDto addNewUser(UserRequestDto requestDto) {
        ...
        CompanyShortResponseDto companyDto = getCompanyDto(requestDto.getCompanyId());
    ...
    public UserResponseDto updateUser(Long id, UserUpdateRequestDto requestDto) {
        ...
        CompanyShortResponseDto companyDto;
    ...
    private CompanyShortResponseDto getCompanyDto(Long companyId) {
        CompanyShortResponseDto companyDto = userManager.getCompanyDto(companyId);
        if (companyDto == null) {
